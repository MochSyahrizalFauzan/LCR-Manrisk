...
import "../style/LCR.css"; // CSS khusus LCR
  ...
  return (
    <div className="dashboard">
      ...
      <div className="main-content p-4">
        ...
        {/* Grand Totals */}
        <div className="card mb-4 mt-4 shadow-sm" style={{ backgroundColor: "#fff" }}>
        ...
        {/* Catatan */}
        <div className="mb-5 text-end small text-muted">
          <small>
            Catatan: Komponen dan haircut diset konstan sesuai per-level. Hanya kolom kuning yang bisa diedit.
          </small>
        </div>
      </div>
    </div>
